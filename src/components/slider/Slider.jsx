...
function Slider() {
    ...
    const handlesubmit = (direction) => {
        if(direction === "left"){
            setSlideIndex(slideIndex > 0 ? slideIndex - 1 : className="disabled")
        }else{
  ...
  return (
    <div className='slider-container'>
        <div className="arrow" direction="left" onClick={()=>handlesubmit("left")}>
        ...
        <div className='arrow' direction="right" onClick={()=>handlesubmit("right")}>
